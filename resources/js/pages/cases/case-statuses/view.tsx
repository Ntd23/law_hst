...
import { Tag, FileText, Lock, Calendar, Palette } from 'lucide-react';
        ...
        <DialogContent className="max-w-xl max-h-[90vh] overflow-y-auto p-0" onOpenAutoFocus={(e) => e.preventDefault()}>
            <DialogHeader className="px-6 pt-6 pb-4 border-b">
                <div className="flex items-center gap-3">
                    ...
                    <DialogTitle className="text-xl font-semibold">{t('Case Status Details')}</DialogTitle>
                </div>
            </DialogHeader>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <div className="mt-1 flex items-center gap-2">
                            <div className="w-5 h-5 rounded border" style={{ backgroundColor: record?.color || '#10b77f' }} />
                    ...
                    <div>
                        ...
                        <div className="mt-1">
                            <span className={`inline-flex items-center rounded-md px-2 py-1 text-xs font-medium ring-1 ring-inset ${
                                ...
                                {record?.is_closed ? t('Closed') : t('Open')}
                            </span>
                        </div>
                    </div>
                </div>
