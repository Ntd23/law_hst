        ...
        <DialogContent className="max-w-xl max-h-[90vh] overflow-y-auto p-0" onOpenAutoFocus={(e) => e.preventDefault()}>
            <DialogHeader className="px-6 pt-6 pb-4 border-b">
                <div className="flex items-center gap-3">
                    ...
                    <DialogTitle className="text-xl font-semibold">{t('Research Citation Details')}</DialogTitle>
                </div>
            </DialogHeader>
            ...
            <div className="px-6 py-4 pb-6 space-y-4">
                    ...
                    <div>
                        ...
                        <div className="mt-1">
                            <span className={`inline-flex items-center rounded-md px-2 py-1 text-xs font-medium ring-1 ring-inset ${
                                typeColors[record?.citation_type] || typeColors.other
                            }`}>
                ...
                {record?.page_number && (
                    <div>
                        ...
                        <p className="mt-1 text-sm font-medium text-gray-900 dark:text-white">{record.page_number}</p>
                    </div>
                )}
