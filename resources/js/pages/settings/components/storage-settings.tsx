...
export default function StorageSettings({ settings = {} }: StorageSettingsProps) {
    ...
    const renderFileTypeSelector = () => (
        <div className="space-y-2">
            <Label required>{t("Allowed File Types")}</Label>
    ...
    return (
        <SettingsSection
            ...
            action={
                <Button type="submit" form="storage-settings-form" size="sm" disabled={isSaving}>
                    ...
                    <CardContent className='mt-6'>
                        ...
                        >
                            <TabsList className="grid w-full grid-cols-3">
                                <TabsTrigger value="local" className="flex items-center gap-2 cursor-pointer">
                                    <HardDrive className="h-4 w-4" />
                                    {t("Local Storage")}
                                </TabsTrigger>
                                <TabsTrigger value="aws_s3" className="flex items-center gap-2 cursor-pointer">
                                    <span>☁️</span>
                                    {t("AWS S3")}
                                </TabsTrigger>
                                <TabsTrigger value="wasabi" className="flex items-center gap-2 cursor-pointer">
                                    <span>🗄️</span>
                                    {t("Wasabi")}
                                </TabsTrigger>
                            </TabsList>
