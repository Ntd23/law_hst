...
import { Scale, FileText, Lock, Tag, Award } from 'lucide-react';
...
export default function View({ record }: ViewProps) {
    ...
    const isPrimary = record?.is_primary === true || record?.is_primary === 1 || record?.is_primary === 'true';
        ...
        <DialogContent className="max-w-xl max-h-[90vh] overflow-y-auto p-0" onOpenAutoFocus={(e) => e.preventDefault()}>
            <DialogHeader className="px-6 pt-6 pb-4 border-b">
                <div className="flex items-center gap-3">
                    ...
                    <DialogTitle className="text-xl font-semibold">{t('Practice Area Details')}</DialogTitle>
                </div>
            </DialogHeader>
            ...
            <div className="px-6 py-4 pb-6 space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <p className="mt-1 text-sm font-medium text-gray-900 dark:text-white">
                            {expertiseLabels[record?.expertise_level] || record?.expertise_level || '-'}
                        </p>
                    </div>
                </div>
                ...
                {record?.certifications && (
                    <div>
                        ...
                        <p className="mt-1 text-sm font-medium text-gray-900 dark:text-white">{record.certifications}</p>
                    </div>
                )}
            </div>
        </DialogContent>
