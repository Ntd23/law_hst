...
import { Edit, Lock, Search, Trash2, X, FileText, ChevronDown, ChevronUp } from 'lucide-react';
...
export default function DocumentTypes() {
    ...
    }, [checkOverflow, documentTypes?.data]);
    ...
    const handleResetFilters = () => {
        ...
        router.get(route('advocate.document-types.index'), {}, { preserveState: true, preserveScroll: true });
    };
    ...
    const canToggle = hasPermission(permissions, 'toggle-status-document-types');
    ...
    return (
        <PageTemplate title={t('Document Types')} description={t('Define and manage document type classifications.')} url="/advocate/document-types" breadcrumbs={breadcrumbs} noPadding>
                    ...
                    <div className="sticky top-4 rounded-lg border border-gray-200 bg-white shadow-sm dark:border-gray-700 dark:bg-gray-800">
                        <div className="border-b border-gray-200 p-6 dark:border-gray-700">
                            ...
                            <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">
                                {formMode === 'create' ? t('Fill in the details to create a new document type') : t('Update the document type details below')}
                            </p>
                        </div>

                        <form onSubmit={handleFormSubmit} className="space-y-4 p-6">
                            <div className="space-y-2">
                                <Label htmlFor="name" required>{t('Document Type Name')}</Label>
                                <Input id="name" type="text" value={formData.name}
                                    onChange={(e) => setFormData({ ...formData, name: e.target.value })}
                                    placeholder={t('eg. Contract, Affidavit')}
                            ...
                            <div className="space-y-2">
                                ...
                                <Textarea id="description" value={formData.description}
                                    ...
                                    placeholder={t('Enter document type description...')}
                        ...
                        <div className="space-y-4">
                            <div className="flex gap-2">
                                <div className="relative flex-1">
                                    ...
                                    <Input type="text" placeholder={t('Search document types...')} value={searchTerm}
                        ...
                        {(documentTypes?.data || []).length > 0 ? (
                            <>
                                {/* <div className="border-b border-gray-200 px-6 py-4 dark:border-gray-700">
                                    ...
                                    <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">{t('Manage document type categories for your organization.')}</p>
                                </div> */}
                                ...
                                {documentTypes?.total > (documentTypes?.per_page || 10) && (
                                    <div className="border-t border-gray-200 dark:border-gray-700">
                                        <Pagination
                                            from={documentTypes?.from || 0} to={documentTypes?.to || 0}
                                            total={documentTypes?.total || 0} links={documentTypes?.links}
                            ...
                            <div className="p-12 text-center">
                                ...
                                <p className="mx-auto mb-6 max-w-sm text-gray-500 dark:text-gray-400">
                                    {hasActiveFilters() ? t('No document types match your search criteria. Try adjusting your filters.') : t('Create document types to categorize your documents.')}
                                </p>
